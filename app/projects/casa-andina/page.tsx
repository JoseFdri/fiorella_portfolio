...
const PROJECT_NAME = "Casa Andina";
const TITLE = `${PROJECT_NAME} | ${author}`;
...
const Section = ({ children, className = "", id }: SectionProps) => (
  <section id={id} className={`flex w-full ${className}`}>
    {children}
  </section>
);
...
const ProjectInfoItem = ({ label, content }: ProjectInfoItemProps) => (
  <div>
    <div className="font-thin my-5">{label}</div>
...
const NavigationItem = ({ number, label, href }: NavigationItemProps) => (
  <a href={href} className="flex items-center justify-center md:flex-col md:w-52 text-center mt-5 md:mt-0">
...
export default function Project() {
  return (
    <main className="flex container flex-col items-center justify-center px-3">
      ...
      <Section className="justify-center lg:mt-44 bg-[#100F1C] w-screen py-7 mt-20 px-3">
        <div className="w-full container md:flex md:justify-between">
          <ProjectInfoItem label="Client" content="Casa Andina" />
          <ProjectInfoItem label="Role" content="UR Designer on a team of 3" />
          <ProjectInfoItem label="Duration" content="2 month" />
          <ProjectInfoItem label="Tools" content={["Sketch", "Invision"]} />
          <ProjectInfoItem 
            label="Process" 
            content={[
      ...
      <Section className="items-start md:items-center flex-col my-20 md:my-24">
        <div className="md:flex-row flex-col items-start md:items-start flex">
          <NavigationItem number="1" label="Immersion" href="#immersion" />
          <NavigationItem number="2" label="Information architecture" href="#architecture" />
          <NavigationItem number="3" label="Reflection" href="#reflection" />
        </div>
      </Section>
      ...
      <Section id="immersion">
        <div className="flex flex-col w-full">
          ...
          <div className="md:flex w-full md:justify-between mt-10">
            <div className="md:w-2/4 md:pr-10">
          ...
          <div className="md:flex w-full md:justify-between mt-14 md:mt-20">
            <div className="md:w-2/4 md:pr-10">
              <h3 className="text-1xl md:text-2xl mb-5 font-bold">
                Interviews with stakeholders
              </h3>
      ...
      <Section className="justify-center flex-col items-center">
      ...
      <Section className="mt-10 md:mt-20" id="architecture">
        <div className="flex flex-col w-full">
      ...
      <Section className="my-28" id="reflection">
        <div className="flex flex-col w-full">
          <h2 className="text-2xl md:text-5xl mb-5 font-bold lg:mb-16 text-center">
            3. Reflection
          </h2>
